...
void CStory::Act1()
{
    ...
    //{
    //    enemy[i] = new CEnemy(200, i + 2);
    //    //std::cout << "enemy " << i << " created" << std::endl;
    //    //std::cout << "Enemy " << i << " Position = " << enemy[i]->getObjPos() << std::endl;
    //    if (i == 0)
    //    {
    //        enemy[i] = new CEnemy(200, 1);
    //        //std::cout << "enemy " << i << " created" << std::endl;
    //    }
    //    if (i == 1)
    //    {
    ...
    ////std::cout << "Weapon Location = " << weapon->getObjPos() << std::endl;
