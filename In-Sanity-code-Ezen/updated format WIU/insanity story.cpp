...
Input:
	...
	if (input == "fight")
	{
		...
		std::string fight5 = "You did it. You’re no longer afraid. What's next?";
		...
		if (input == "murder") {
			...
			std::string kill1 = "You decide that you'll kill the rest, for you are no longer afraid. I like that. Go on then, do what you must.";
			...
			std::string kill2 = "As the voice disappears, your head rises to scan the environment, covered in the creature's blood. Sure Enough, you see more and more grotesque creatures approaching you. Some with faces that resemble horror, others resembling anger, you can't quite make it out. Even new creatures you've never seen before. Crawling on the floor lies a ball of rotting meat with serrated teeth growling at you.";
			...
			std::string kill3 = "You flinch back, but remember. They are mortal, they can be killed. Don’t be afraid. Attack!";
			...
			std::string kill4 = "Having no choice but to follow the voice, you attack and attack and attack. Hearing the cries and what sounds like eldritch gibberish. You can’t help but feel that they’re asking, pleading you for something. You shouldn't stop now, you've come so far!";
			...
			std::string kill5 = "Kill! Kill! Kill! Don't you dare stop. More are on the way. Don't Stop. You don't want to lose your freedom again do you? Listen to Me. Kill them All.";
			...
			std::string kill6 = "As you keep on killing, soon the cries stop. Leaving you all alone covered in the blood of the creatures. As you look at the corpses, your vision starts to clear bit by bit revealing the truth of your actions. As you stare at what you’ve done, your vision regains its blurriness.";
			...
			std::string kill7 = "Don't think about them. They're just deadweight. They don't understand our suffering. They only want to separate us. You don’t want that.  We're free now. Come on, let's get going. More will come if we don’t leave.";
			...
			std::string kill8 = "Listening to the voice, you make your way out of the nightmare. Finally being free, you make your way back to your safe haven. As you're walking, covered in blood. You hear more and more screams of terror all around you. Kill them. They won't seperate us. We're in this together. I promise I will keep us safe. We're partners. Give me Control.";
			...
			if (input == "surrender") {
				std::string surrender1 = "Ahhhhh. Finally, Some freedom. Don’t worry. I'll take care of them. I will protect you. Get some rest, you won't feel our pain ever again.";
				...
				std::string surrender2 = "As Austin falls to his slumber. I deal with our problems, finally free. No one will stop us anymore. You're safe Austin. Safe with me.";
			...
			if (input == "resist") {
				std::string resist1 = "Be like that then. See for yourself how long you can survive without me. The voices then stop. It's silent for the first time in a long while, it's just me. The deafening silence continues, my vision returns back to normal and I see what were the monsters surrounding me, the neighbours terrified as they call the police.";
				...
				std::string resist2 = "Within minutes, the police arrive. Approaching me covered in human blood, they walk slowly towards me, wary of the danger I might pose. Seeing that I wasn't a threat to them, they rushed forward. Tackling me down and detaining me before I could react.";
				...
				std::string resist3 = "Next thing I know, I'm locked up in a dark empty cell. No light came through except for the holes in the iron door in front of me. I found myself  tied up and unable to move a single part of my body.";
				...
				std::string resist4 = "See what I told you Austin? Now look at us. Trapped, unable to move. This is all your fault. You could have just given me control but now? Now it's too late to even bother anymore. Have fun being alone, Austin.";
				...
				std::string resist5 = "My consciousness begins to fade while trying to keep myself from dozing off. I wonder, was it really the right decision? To remain in control. It’s my own body… isn't it?";
		...
		if (input == "escape") {
			...
			std::string escape1 = "You choose to leave. A wise decision. You decide to make your move and escape. The rest are growing suspicious.";
			...
			std::string escape3 = "As you make your way to the exit. You hear sirens coming from all angles around you. You're surrounded.  Run for it. Don't let them catch you!";
	...
	if (input == "flee") {
		...
		if (input == "right") {
			std::string flee2 = "You take the next turn you find, into a room. Footsteps trail closely behind. Hide.";
			...
			if (input == "closet") {
				std::string closet1 = "You shut yourself into the closet as darkness shrouds you, you blend in with the dark spaces. The being runs into the room. Briefly scanning the room. His panic comes to a stop, scanning the room again, more thoroughly this time.";
				...
				std::string closet2 = "The being steps into the room hurriedly, the frantic footsteps getting closer by the second.";
				...
				std::string closet3 = "They wander around for a bit, then silence.You can hear the footsteps grow more distant, only moving from under the bed when you feel safe.";
			...
			//Succeed: it leaves the room and slams the door shut.You’re safe, for now.

			//Fail : he forces the door open and grabs you from inside the coset.Darkness envelops you once more.Close.Not close enough.
...
int Act2()
	{
		...
		if (dogkey == false && greenkey == false)
		{
			if (input == "doghouse") {
			DogHouse:
				std::string dog1 = "In place of what would seemingly be a dog, lies a mass of rotting flesh, to the point where it seems undead. Bones protruding out of its spiny body. It's hard to make out its full shape but you notice hints of exposed organs and many layers of serrated teeth, you can tell it'll only end badly if you get caught. Its teeth grind against itself when it snores. The stench of its rotting yet living corpse wafting through the air every snore, making it hard to not hurl. The scraping noises pierce your ears every time it happens.";
				...
				std::string dog2 = "Hanging above the door of the doghouse, lies a key. That's what you need. That’s what we need to escape. ";
				...
				std::string dog4 = "As you get closer, your footsteps become more apparent to it. It starts to twist and turn, before going back to sleep. You would be wise to tread carefully now.";
				...
				if (input == "reckless") {
					std::string reckless1 = "You throw all caution to the wind, sprinting to the key. The 'dog' awakens, it snarls before leaping onto you. You try to dodge it, but it seems as though you are too slow. It pounces on top of you, drooling all over you. Its acidic saliva-like substance melting into you. Darkness envelops you once more. Close. Not close enough.";
			...
			{
			GreenHouse:
				std::string green1 = "You make your way into the greenhouse. The greenery withered, the glass fogged. You hear a loud snipping, unsure of who's responsible for it, you take cover within the decaying plants. Out looms a figure, tall and lanky. Hair covering it, all the way from head to chest. Her movements seem sudden and robotic. There it is again, the snipping noise. In her seemingly frail and boney hands, a pair of large garden shears, dull and rotten. The blade with rust, the handles peeling off.";
				...
				std::string green2 = "You notice a key, shimmering like a rose amongst thorns. That's what you need, that's what we need to escape. The task is simple, but it's not going to be easy. You study the vague resemblance of a gardener, wandering around the greenhouse. Her patterns are random, erratic, unpredictable. Be on guard. Don't get caught.";
	...
	End:
		std::string End1 = "You clutch both keys, one in each hand. Freedom. You unlock the gates, the locks surprisingly quiet. You push open the creaky doors, they slide out of the way. The scenery is still dreadful, dark, and desolate as ever. The air feels heavy, yet it still relieves you. As though a great weight has been lifted off your chest. As you wander, the trees start to distort, buildings start to warp. You begin to lose your grip on reality. Fearing for your life, you run. Run. run as fast and as far as you can but no matter what you do you can't escape it.";
		...
		std::string End2 = "You trip, landing face first into the dirt. flipping yourself over, you see a familiar park. It seems like such a distant memory, yet you remember it so vividly. You make your way to a bench, almost subconsciously, like you're aware of this location. You lie down to shut your eyes, getting some rest after a dreadful day. As you dove off to sleep, you see 2 figures loom over you. Too tired to fight back, you accept their cold embrace, as well as your fate.";
